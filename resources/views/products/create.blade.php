                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="serial_number"
                                                class="form-label text-xs font-weight-bold text-uppercase">Serial Number
                                                (SKU)</label>
                                            <input type="text"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror" id="type"
                                                ...
                                                <option value="Food & Snacks"
                                                    {{ old('type') == 'Food & Snacks' ? 'selected' : '' }}>Food & Snacks
                                                </option>
                                                <option value="Beverages"
                                                    {{ old('type') == 'Beverages' ? 'selected' : '' }}>Beverages</option>
                                                <option value="Daily Essentials"
                                                    {{ old('type') == 'Daily Essentials' ? 'selected' : '' }}>Daily
                                                    Essentials</option>
                                                <option value="Electronics"
                                                    {{ old('type') == 'Electronics' ? 'selected' : '' }}>Electronics
                                                </option>
                                            </select>
                                            @error('type')
                                                <div class="invalid-feedback text-xs">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="expiration_date"
                                                class="form-label text-xs font-weight-bold text-uppercase">Expiration
                                                Date</label>
                                            <input type="date"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="price"
                                                class="form-label text-xs font-weight-bold text-uppercase">Price
                                                (IDR)</label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="stock"
                                                class="form-label text-xs font-weight-bold text-uppercase">Initial
                                                Stock</label>
                                            <input type="number"
                                                class="form-control @error('stock') is-invalid @enderror" id="stock"
                                                name="stock" value="{{ old('stock') }}" placeholder="0"
                                                min="0" required>
                                            @error('stock')
                                                <div class="invalid-feedback text-xs">{{ $message }}</div>
                                            @enderror
