    ...
    <div class="auth-split auth-split--single">
        <div class="auth-panel">
            <div class="auth-header auth-header--center">
                ...
                <h2 class="auth-header__title">Gabung Mitra Pengiriman</h2>
                <p class="auth-header__sub">Daftar sekarang untuk menjadi kurir kami</p>
            </div>
            ...
            <form action="{{ route('register.courier.store') }}" method="POST" id="registerForm">
                ...
                <div class="auth-grid">
                    <div class="auth-field">
                        <label for="name" class="auth-label">Nama Lengkap (Sesuai KTP)</label>
                ...
                <div class="auth-field">
                    ...
                    <input type="number" id="phone" name="phone" class="auth-input"
                        placeholder="08xxxxxxxxxx" value="{{ old('phone') }}" required>
                    <span class="auth-hint">Nomor ini akan digunakan untuk koordinasi pengiriman.</span>
                </div>
                ...
                <button type="submit" class="neon-btn" id="submitBtn">Kirim Lamaran</button>
                <p class="auth-info">
