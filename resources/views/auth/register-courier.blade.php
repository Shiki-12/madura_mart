    ...
    <div class="register-container">
        ...
        <form action="{{ route('register.courier.store') }}" method="POST" id="registerForm">
            ...
            <div class="form-group">
                ...
                <input type="number" id="phone" name="phone" placeholder="08xxxxxxxxxx"
                    value="{{ old('phone') }}" required>
                <small style="color: #888; font-size: 0.8rem; margin-top: 5px; display:block;">Nomor ini akan digunakan
                    untuk koordinasi pengiriman.</small>
            </div>
