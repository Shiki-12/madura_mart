...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-header h2 { font-size: 2rem; font-weight: 700; color: #333; margin-bottom: 10px; }
        ...
        .remember-me label { color: #666; cursor: pointer; font-size: 0.95rem; }
        .forgot-password { color: #667eea; text-decoration: none; font-size: 0.95rem; font-weight: 600; transition: color 0.3s ease; }
        ...
        .divider {
            display: flex; align-items: center; text-align: center; margin: 30px 0; color: #999;
        }
        ...
        .social-btn {
            ...
            justify-content: center; gap: 10px; font-weight: 600; color: #333;
            transition: all 0.3s ease; font-family: 'Instrument Sans', sans-serif;
        }
        .social-btn:hover { border-color: #667eea; background: #f8f9ff; }

        .register-link { text-align: center; color: #666; font-size: 0.95rem; }
        .register-link a { color: #667eea; text-decoration: none; font-weight: 600; transition: color 0.3s ease; }
        .register-link a:hover { color: #764ba2; }

        /* Courier Link Style */
        .courier-link {
            text-align: center; margin-top: 20px; padding-top: 15px; border-top: 1px solid #f0f0f0;
        }
        .courier-link p { font-size: 0.85rem; color: #888; margin-bottom: 5px; }
        .courier-link a {
            color: #ff9f43; /* Warna Orange biar beda */
            text-decoration: none; font-weight: 600; font-size: 0.95rem; display: inline-flex; align-items: center; gap: 5px;
        }
        .courier-link a:hover { color: #e67e22; }
    ...
    <script>
        function togglePassword() {
            ...
            if (passwordInput.type === 'password') {
                passwordInput.type = 'text'; toggleBtn.textContent = '👁️‍🗨️';
            } else {
                passwordInput.type = 'password'; toggleBtn.textContent = '👁️';
            }
        }
        setTimeout(() => {
