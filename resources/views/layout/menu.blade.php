<div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
            ...
            <a class="nav-link {{ Request::is('products*') ? 'active' : '' }}" href="{{ route('products.index') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        ...
                        <path d="M11.25,5.5c-.414,0-.75-.336-.75-.75v-1.75c0-.827-.673-1.5-1.5-1.5s-1.5,.673-1.5,1.5v1.75c0,.414-.336,.75-.75,.75s-.75-.336-.75-.75v-1.75c0-1.654,1.346-3,3-3s3,1.346,3,3v1.75c0,.414-.336,.75-.75,.75Z"></path>
                        <path d="M15.406,6.512c-.125-1.432-1.302-2.512-2.739-2.512H5.333c-1.437,0-2.615,1.08-2.739,2.512l-.652,7.5c-.067,.766,.193,1.53,.712,2.097s1.258,.892,2.027,.892H13.318c.769,0,1.508-.325,2.027-.892s.779-1.331,.712-2.097l-.652-7.5Z"></path>
                    </svg>
                </div>
        ...
        {{-- CLIENTS --}}
        <li class="nav-item">
            <a class="nav-link {{ Request::is('clients*') ? 'active' : '' }}" href="#"> {{-- Ganti href dengan route('clients.index') jika sudah ada --}}
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ Request::is('clients*') ? 'white' : '#67748e' }}" 
        ...
        {{-- ORDER --}}
        <li class="nav-item">
            <a class="nav-link {{ Request::is('orders*') ? 'active' : '' }}" href="#"> {{-- Ganti dengan route('orders.index') --}}
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ Request::is('orders*') ? 'white' : '#67748e' }}" 
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('sales*') ? 'active' : '' }}" href="{{ route('sales.index') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ Request::is('sales*') ? 'white' : '#67748e' }}" 
        ...
        {{-- COURIER --}}
        <li class="nav-item">
            <a class="nav-link {{ Request::is('couriers*') ? 'active' : '' }}" href="#"> {{-- Ganti dengan route('couriers.index') --}}
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ Request::is('couriers*') ? 'white' : '#67748e' }}" 
        ...
        {{-- USERS --}}
        <li class="nav-item">
            <a class="nav-link {{ Request::is('users*') ? 'active' : '' }}" href="#"> {{-- Ganti dengan route('users.index') --}}
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ Request::is('users*') ? 'white' : '#67748e' }}" 
                    ...
                    <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-1717.000000, -291.000000)" 
                               fill="{{ Request::is('reports/distributor*') ? 'white' : '#67748e' }}" fill-rule="nonzero">
                                <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-1870.000000, -591.000000)" 
                               fill="{{ Request::is('reports/product*') ? 'white' : '#67748e' }}" fill-rule="nonzero">
                                <g transform="translate(1716.000000, 291.000000)">
            ...
            <a class="nav-link {{ Request::is('reports/order*') ? 'active' : '' }}" href="#">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                        <defs><style>.cls-1 {fill: {{ Request::is('reports/order*') ? 'white' : '#67748e' }}}</style></defs>
                        <g id="purchase">
                            <path class="cls-1" d="M28.3 18H24v-3a3 3 0 0 0-6 0v3h-4.3a1.7 1.7 0 0 0-1.7 1.7v1.6a1.71 1.71 0 0 0 1.39 1.7l.18 1H4.29a.29.29 0 0 1-.29-.29V4.29A.29.29 0 0 1 4.29 4h15.42a.29.29 0 0 1 .29.29V9a1 1 0 0 0 2 0V4.29A2.3 2.3 0 0 0 19.71 2H4.29A2.3 2.3 0 0 0 2 4.29v19.42A2.3 2.3 0 0 0 4.29 26h9.63l.31 1.76A2.7 2.7 0 0 0 16.89 30H21a1 1 0 0 0 0-2h-4.11a.71.71 0 0 1-.69-.58L15.42 23h11.16l-.78 4.42a.71.71 0 0 1-.69.58 1 1 0 0 0 0 2 2.7 2.7 0 0 0 2.66-2.24l.84-4.76A1.71 1.71 0 0 0 30 21.3v-1.6a1.7 1.7 0 0 0-1.7-1.7zm-.3 2v1h-4v-1zm-14 0h4v1h-4zm6-5a1 1 0 0 1 2 0v6h-2z" />
                            <path class="cls-1" d="M7 6a1 1 0 1 0 1 1 1 1 0 0 0-1-1zM17 6h-7a1 1 0 0 0 0 2h7a1 1 0 0 0 0-2zM7 10a1 1 0 1 0 1 1 1 1 0 0 0-1-1zM18 11a1 1 0 0 0-1-1h-7a1 1 0 0 0 0 2h7a1 1 0 0 0 1-1zM7 14a1 1 0 1 0 1 1 1 1 0 0 0-1-1zM10 14a1 1 0 0 0 0 2h5a1 1 0 0 0 0-2z" />
                        </g>
                    </svg>
                </div>
        ...
        {{-- SALE REPORTS --}}
        <li class="nav-item">
            <a class="nav-link {{ Request::is('reports/sale*') ? 'active' : '' }}" href="{{ route('reports.sale') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="57px" height="57px" viewBox="0 0 18 18">
                        ...
                        <path d="M2.75,9.5c.192,0,.384-.073,.53-.22l4.72-4.72v.689c0,.414,.336,.75,.75,.75s.75-.336,.75-.75V2.75c0-.414-.336-.75-.75-.75h-2.5c-.414,0-.75,.336-.75,.75s.336,.75,.75,.75h.689L2.22,8.22c-.293,.293-.293,.768,0,1.061,.146,.146,.338,.22,.53,.22Z" 
                              fill="{{ Request::is('reports/sale*') ? 'white' : '#67748e' }}" data-color="color-2"></path>
                    </svg>
                </div>
